      ...
      body: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          height: MediaQuery.of(context).size.height -
              adminListAppbarDesign().preferredSize.height -
              MediaQuery.of(context).padding.top,
          child: Padding(
            padding: EdgeInsets.symmetric(vertical: 20.h, horizontal: 20.w),
            child: StreamBuilder(
                stream: FirestoreDb().admins,
                builder: (_, AsyncSnapshot snapshot) {
                  if (snapshot.hasData) {
                    List<Admin> adminList = snapshot.data;
                    return Column(
                      children: [
                        Expanded(
